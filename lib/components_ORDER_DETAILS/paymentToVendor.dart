...
final List<String> kVendorCurrencies = [
  'IDR', 'RMB', 'EUR', 'USD', 'SGD', 'MYR',
  'JPY', 'CHF', 'KRW', 'TWD', 'HKD', 'MOP', 'AUD',
];


class PaymentToVendorWidget extends StatefulWidget {
  final String orderId;

  const PaymentToVendorWidget({Key? key, required this.orderId}) : super(key: key);

  @override
  State<PaymentToVendorWidget> createState() => _PaymentToVendorWidgetState();
}

class _PaymentToVendorWidgetState extends State<PaymentToVendorWidget> {
  // Store draft uploads
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Text("Payments To Vendor", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),

                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                  decoration: BoxDecoration(color: Colors.grey[100], borderRadius: BorderRadius.circular(4)),
                  child: const Text("Expenses", style: TextStyle(fontSize: 10, color: Colors.grey)),
                )
              ],
            ),
          ),
      ...
      builder: (context, snapshot) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            // Map CNY to RMB for display if needed
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      flex: 2,
                      child: SizedBox(
                        height: 50, // Standard height matching Dropdown
                        child: TextField(
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          items: kVendorCurrencies.map<DropdownMenuItem<String>>((String value) {
                  ...
                  Row(
                    children: [
                      ...
                      DropdownButton<String>(
                        ...
                        items: kVendorCurrencies.map((c) => DropdownMenuItem(
                          value: c,
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    try {
                      // Note: Updating 'expenses' collection
